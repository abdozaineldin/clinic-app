...
export const MOCK_ABOUT: AboutPageData = {
  ...
  certifications: [
    { id: 1, name: "البورد المصري للأمراض الجلدية" },
    { id: 2, name: "زمالة الجمعية المصرية للجلدية والتناسلية" },
    { id: 3, name: "عضوية الجمعية الأوروبية للجلدية (EADV)" },
    { id: 4, name: "شهادة معتمدة في العلاج بالليزر" },
  ],
  pressLogos: [
    { id: 1, name: "قناة النهار" },
    { id: 2, name: "CBC" },
    { id: 3, name: "صدى البلد" },
    { id: 4, name: "ET بالعربي" },
  ],
  philosophyQuote:
